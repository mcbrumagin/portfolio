...
window.Jsml = new function Jsml() {
    ...
    */
    ...
    _.parseStyle = function (style) {
        // if global style
            // check each selector
                // match each property of the selector to found elements
        // else if scoped style
            // do the same as the above
            // but prepend all selectors with this one
        // else if inline style
            // do the same as above
            // but search from this node for nested selectors
    }
