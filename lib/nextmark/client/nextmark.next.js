    ...
    _.convertMarkdown = function (markdown) {
        ...
        for (var i = 0; i < lines.length; i++) {
            ...
            var createCodeBlock = function () {
                ...
                var highlight = function (content, config) {
                    ...
                    var find = function (query, text, preprocess) {
                        ...
                        do {
                            ...
                            if (match !== null) {
                                ...
                                if (match[0] !== match[1]) {
                                    var reg = new RegExp(/* TODO: Escape */ '(' + match[1] + ')')
                                    var nestedMatch = reg.exec(match[0])
                                    if (nestedMatch) match.index = match.index + nestedMatch.index
                                    console.log('Processing nestedMatch',
                                        reg, nestedMatch)
                                }
